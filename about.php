            ...
            <div class="row justify-content-center">
                <div class="col-lg-10">
                    <div class="services-title text-center">
                        ...
                        <p>Women are the better half portions of this world. We take the <b style="color:#ef7b4c;">‘Evolution’</b> of female hygiene to a place where it is connected to the <b style="color:#ef7b4c;">‘Eternal’</b> energy of earth, with biodegradable range of products thatlifts up your soulduring some dull days, with a big smile to ‘Heal you Naturally’ </p>
                    </div>
                </div>
            </div>
			 ...
			 <div class="row justify-content-center">
                <div class="col-lg-10">
                    <div class="services-title text-center">
                       <h5 style="padding-top:30px;color:#ef7b4c;">‘Nothing is constant but change’</h5>
						<p>Humans have ‘Evolved’ over centuries through a process of mental, physical, emotional and spiritual 360~ degrees change, especially with regional influences into the world of Women and them being ‘Blessed to Bleed’.</p>
						<p>We take this blessing as our opportunity to serve the Women-kind and the Mother earth at the same time, Hence, we call this unique move as ‘to Evolve beautifully!’</p>
				   </div>
                </div>
            </div>
        </div>
