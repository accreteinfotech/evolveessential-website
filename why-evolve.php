...
<section class="page-banner bg_cover" style="background-image: url(assets/images/page-banner-4.jpg);">
        <div class="container">
            <div class="page-banner-content text-center">
                <h2 class="title">Why Evolve</h2>
                <ol class="breadcrumb justify-content-center">
                    <li class="breadcrumb-item"><a href="index.php">Home</a></li>
                    <li class="breadcrumb-item active">Why Evolve</li>
                </ol>
            </div>
        </div>
    </section>
    ...
    <section class="services-page pt-100 pb-50">
        <div class="container">
	...
	<section class="faqs-page pt-20 pb-100">
        <div class="container">
            <div class="row" style="    background-color:#ef7b4c;padding:50px;">
                <div class="col-lg-6" style="border: 1px solid #fff;
    padding: 30px;">
                    <div class="single-faqs">
					
                        <h4 class="title" style="color:#fff;">Solely crafted for you!</h4>
                        <p style="color:#fff;">Each one is different and possess their own set of needs with their choice of products, hence we cater to the most essential needs. We do no exaggerate but ‘Emit’ the nature’s essence for you!</p>
                    </div>
                </div>
    ...
    border-left: none;">
                    <div class="single-faqs">
                        <h4 class="title" style="color:#fff;">Thoughtfully ecological!</h4>
                        <p style="color:#fff;">Packaging that challenges the norms of a regular and monotonous product possession. We ‘Enlarge’ the perspective of your intimate hygiene and believe in biodegradable adaptation!</p>
                    </div>
                </div>
